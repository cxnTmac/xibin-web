<template>
	<section>
		...
		<el-tabs v-model="activeName" @tab-click="handleClick">
			<el-tab-pane label="未生成销售退货入库成本凭证" name="first">
			</el-tab-pane>
			<el-tab-pane label="已生成销售退货入库成本凭证" name="second">
			</el-tab-pane>
		</el-tabs>
		...
		<el-table :data="orders" border :span-method="objectSpanMethod" highlight-current-row v-loading="listLoading" @selection-change="selsChange" stripe style="width: 100%;">
			...
			<el-table-column prop="orderNo" label="入单号" width="200" >
			</el-table-column>
			...
			<el-table-column prop="inboundNum" label="收货数" width="200">
			</el-table-column>
...
<script>
	...
	import { showAllClosedOrderInboundDetail,accountCostByOrderNos} from '../../api/inboundApi';
	...
	export default {
		data() {
			return {
                ...
                boundType:codemaster.WM_INBOUND_TYPE,
		...
		methods: {
            ...
            getOrders() {
                if(this.activeName === 'first'){
                    ...
                    this.filters.isCostCalculated = 'N';
				}else if(this.activeName === 'second'){
                    this.filters.headerStatus = '99';
                    this.filters.inboundType = 'RI';
                    this.filters.isCostCalculated = 'Y';
				}
				let para = {
