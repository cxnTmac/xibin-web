<template>
	<section>
		...
		<el-tabs v-model="activeName" @tab-click="handleClick">
			<el-tab-pane label="未生成赊销成本凭证" name="first">
			</el-tab-pane>
			<el-tab-pane label="已生成赊销成本凭证" name="second">
			</el-tab-pane>
			<el-tab-pane label="未生成现销成本凭证" name="third">
			</el-tab-pane>
			<el-tab-pane label="已生成现销成本凭证" name="fouth">
			</el-tab-pane>
