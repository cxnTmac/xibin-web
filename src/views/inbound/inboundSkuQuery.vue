<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters" ref="queryForm">
				...
				<el-form-item label="供应商" prop="areaName">
					<popwin-button popKey="POP_CUSTOMER" :showName="true"   v-model="filters.supplierCode"></popwin-button>
				</el-form-item>
		...
		<el-table :data="records" border :span-method="objectSpanMethod" highlight-current-row v-loading="listLoading" @selection-change="selsChange" stripe style="width: 100%;">
			...
			<el-table-column prop="inboundType" label="类别" width="80" :formatter="formatInboundType" >
			</el-table-column>
	...
	export default {
		...
		methods: {
            ...
            getRecords() {
				...
				//NProgress.start();
                queryWmInboundDetailByPage(para).then((res) => {
