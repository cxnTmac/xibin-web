	...
	<section>
		...
		<el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="是否启用">
					<el-select :disabled="true" v-model="addForm.isEnable" placeholder="请选择">
						<el-option
								v-for="item in yes_no"
								:key="item.code"
								:label="item.name"
...
<script>
	...
	import { getUserListPage, removeUser, saveUser} from '../../api/api';
	...
	export default {
		data() {
			return {
				...
				yes_no:codemaster.SYS_USER_STATUS,
				filters: {
					userName: ''
				},
				users: [],
		...
		methods: {
            ...
            formatYorN: function (row, column) {
                return util.getComboNameByValue(codemaster.SYS_USER_STATUS,row.isEnable);
			},
