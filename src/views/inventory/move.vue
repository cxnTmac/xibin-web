  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px">
      <el-form :inline="true" :model="filters" ref="queryForm">
        <el-row :gutter="0">
          ...
          <el-button type="primary" style="float: right" v-on:click="batchPrintSkuLabels">批量打印产品标签</el-button>
        </el-row>
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="目标库位" prop="toLoc">
              <popwin-button popKey="POP_LOC" :selectValue="operateForm.toLoc"
                v-model="operateForm.toLoc"></popwin-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="移动数" prop="moveNum">
              <el-input-number v-model="operateForm.moveNum" :min="0" :max="operateForm.invAvailableNum"
                label="输入要移动的数量"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-dialog title="移动" :visible.sync="transferFormVisible" :close-on-click-modal="false">
      <el-form :model="transferForm" label-width="80px" :rules="transferFormRules" ref="transferForm">
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="目标库位" prop="toLoc">
              <popwin-button popKey="POP_LOC" :selectValue="transferForm.toLoc"
                v-model="transferForm.toLoc"></popwin-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="目标产品" prop="toLoc">
              <popwin-button popKey="POP_SKU" :selectValue="transferForm.toSku"
                v-model="transferForm.toSku"></popwin-button>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="转变数" prop="transferNum">
              <el-input-number v-model="transferForm.transferNum" :min="0" :max="transferForm.invAvailableNum"
                label="输入要移动的数量"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="产品编码" prop="toLoc">
              <popwin-button popKey="POP_SKU" :selectValue="addForm.skuCode" v-model="addForm.skuCode"></popwin-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="产品名称" prop="skuName">
              <el-input v-model="addForm.skuName" auto-complete="off" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="库位" prop="toLoc">
              <popwin-button popKey="POP_LOC" :selectValue="addForm.locCode" v-model="addForm.locCode"></popwin-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="库存可用数" prop="invAvailableNum">
              <el-input-number v-model="addForm.invAvailableNum"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="产品价值" prop="price">
              <el-input-number v-model="addForm.price" :min="0" label="输入产品价值"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click.native="addSubmit" :loading="addLoading">新增库存</el-button>
      </div>
    </el-dialog>
  </section>
</template>
...
export default {
  ...
  methods: {
    batchPrintSkuLabels() {
      let skuCodesArr = this.sels.map(item => item.skuCode);
      let skuCodesArrStr = skuCodesArr.join(',');
      let str = "";
      for (let i =0;i<skuCodesArr.length;i++) {
        str += 'skuCodes=' + skuCodesArr[i] + '&'
      }
