<template>
  <section>
    ...
    <el-dialog
      title="设置关联科目期初余额"
      :visible.sync="courseAuxilaryBalanceFormVisible"
      :close-on-click-modal="false"
    >
      <el-form
        :model="courseAuxilaryBalanceForm"
        label-width="80px"
        :rules="courseAuxilaryBalanceFormRules"
        ...
        <el-row :gutter="0">
          <el-col :span="12">
            <el-form-item label="关联科目" prop="courseNo">
              <el-select
                v-model="courseAuxilaryBalanceForm.courseNo"
                placeholder="请选择"
              >
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="年初余额" prop="balance">
              <el-input-number
                v-model="courseAuxilaryBalanceForm.balance"
                auto-complete="off"
              ></el-input-number>
            </el-form-item>
          </el-col>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click.native="courseAuxilaryBalanceFormVisible = false"
          >取消</el-button
        >
        <el-button
          type="primary"
          @click.native="addBalanceSubmit"
