<template>
    <section>
        <div v-title data-title="通用组"></div>
        <!--工具条-->
            ...
            <el-form :inline="true" :model="filters" ref="queryForm">
                <el-row :gutter="0">
                    ...
                    <el-form-item label="通用产品" prop="fittingSkuCode">
                        <popwin-button popKey="POP_SKU" :selectValue="filters.fittingSkuCode"
                            v-model="addForm.fittingSkuCode"></popwin-button>
                    </el-form-item>
        ...
        <!--列表-->
        <el-table :data="records" border  v-loading="listLoading"
            :row-class-name="tableRowClassName" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="mainSku" label="主产品" width="200" sortable>
            </el-table-column>
...
export default {
    ...
    methods: {
        tableRowClassName({ row, rowIndex }) {
            console.log(row);
            if (row.skuCode.trim() === row.mainSku.trim() ) {
                console.log("成功");
                return "main-sku-row";
            }
        },
