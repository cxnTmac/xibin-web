<template>
	<section>
		<div v-title data-title="配件类别"></div>
		<!--工具条-->
		...
		<!--列表-->
		<el-table :data="fittingTypes" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" stripe style="width: 100%;">
