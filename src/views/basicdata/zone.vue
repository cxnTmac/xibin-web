<template>
	<section>
		<div v-title data-title="库区"></div>
		<!--工具条-->
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters" ref="queryForm">
				<el-row :gutter="0">
					<el-form-item label="所属区域" prop="areaCode">
						<popwin-button popKey="POP_AREA" :showName="true" :selectValue="filters.areaCode" v-model="filters.areaCode" ></popwin-button>
					</el-form-item>
				...
				<el-row :gutter="0">
					...
					<el-col :span="12">
						<el-form-item label="区域" prop="areaCode">
							<popwin-button popKey="POP_AREA" :selectValue="addForm.areaCode" v-model="addForm.areaCode"></popwin-button>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="0">
		...
		<el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-row :gutter="0">
					...
					<el-col :span="12">
						<el-form-item label="区域" prop="areaCode">
							<popwin-button popKey="POP_AREA" :selectValue="editForm.areaCode" v-model="editForm.areaCode" ></popwin-button>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="0">
